...
if __name__ == '__main__':
    """
    select count(*) from test.test_mysql_to_clickhouse;

    select * from test.test_mysql_to_clickhouse;
    
    drop table test.test_mysql_to_clickhouse;

    CREATE TABLE test.test_mysql_to_clickhouse(
        `name` String,
        `age` Int32,
        `detail` String,
        `address` String)
